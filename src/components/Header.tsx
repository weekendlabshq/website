  ...
  return (
    <header className={isActive ? "header active" : "header"}>
      <div className="container">
        ...
        <div className="header__hamburger" onClick={toggleClass}>
          <span></span>
          <span></span>
          <span></span>
        </div>
